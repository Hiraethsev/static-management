<template>
  ...
  <div class="container" :class="{ active: isActive }">
    <div class="signup-section">
      <header @click="activate">登录</header>
      <form>
        <input type="text" placeholder="User" v-model="username" required>
    ...
    <div class="login-section" :class="{ active: !isActive }">
      <header @click="activate">注册</header>
  ...
  methods: {
    login () {
      this.adminList.forEach(element => {
        if (element.admin_user === this.username && element.admin_pwd === this.password) {
